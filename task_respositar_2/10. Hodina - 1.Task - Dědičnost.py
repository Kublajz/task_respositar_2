...
#
# Pomocí dědičnosti implementujte třídu CoffeeMachine (obsahuje informace o kávovaru), třídu Blender (obsahuje informace o mixéru), třídu MeatGrinder (obsahuje informace o mlýnku na maso).
#
...
# Třída MeatGrinder dědící z Device
...
coffee_machine = CoffeeMachine("DeLonghi", "Magnifica S", 1450, 2000)
